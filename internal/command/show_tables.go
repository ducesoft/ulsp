...
func (that *showTables) Attr(ctx lsp.Context, params *lsp.CodeActionParams) *lsp.CodeAction {
...
func (that *showTables) Exec(ctx lsp.Context, conn *jsonrpc2.Conn, params *lsp.ExecuteCommandParams) (any, error) {
